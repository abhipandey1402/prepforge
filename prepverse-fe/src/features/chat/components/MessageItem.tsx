        ...
        <>
            ...
            >
                ...
                <div
                    ...
                    className={classNames(
                        " p-2 rounded-2xl flex flex-col cursor-pointer group hover:bg-orange-500",
                        isOwnMessage
                            ? "order-1 rounded-br-none bg-orange-600"
                            : "order-2 rounded-bl-none bg-neutral-700"
                    )}
                >
                    ...
                    {message.content ? (
                        <div className="relative flex justify-between">
                            ...
                            {isOwnMessage ? (
                                <div
                                    className="self-center relative options-button pr-2"
                                    onClick={() => setopenOptions(!openOptions)}
                                    role="button"
                                >
                                    ...
                                    >
                                        <p
                                            ...
                                            role="button"
                                            className=" p-2 text-danger rounded-sm w-auto inline-flex items-center"
                                        >
