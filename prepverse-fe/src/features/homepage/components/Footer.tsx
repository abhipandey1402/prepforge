...
const Footer: React.FC = () => {
    return (
        <footer className="bg-blue-950 text-gray-400 py-12 border-t border-blue-800">
            <div className="container mx-auto px-4">
                ...
                {/* Bottom Legal Row */}
                <div className="border-t border-blue-900 pt-6 flex flex-col md:flex-row justify-between items-center">
